...
import com.utkarsh.leanassignment.dto.AuthenticationRequest;
import com.utkarsh.leanassignment.dto.AuthenticationResponse;
import com.utkarsh.leanassignment.dto.SignUpResponse;
import com.utkarsh.leanassignment.model.User;
import com.utkarsh.leanassignment.service.CustomUserDetailsService;
import com.utkarsh.leanassignment.utils.JwtUtil;
...
class AuthController {
    ...
    public ResponseEntity<SignUpResponse> signupUser(@RequestBody AuthenticationRequest authenticationRequest){
        try{
        userDetailsService.saveUser(new User(authenticationRequest.getUsername(), authenticationRequest.getEmail(),authenticationRequest.getPassword(),true));}
        catch (Exception e){
            System.out.println(e.getMessage());
